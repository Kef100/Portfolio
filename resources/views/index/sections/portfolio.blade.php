...
<div class="w-full h-screen bg-secondary section">
    ...
    <div
        class="after:content-[''] after:absolute after:left-36 after:top-32 after:bg-no-repeat after:bg-cross after:w-24 after:h-24"></div>
    <div
    ...
    <div
        class="after:content-[''] after:absolute after:right-48 after:top-12 after:bg-no-repeat after:bg-triangle after:w-24 after:h-28"></div>

    <div class="flex relative justify-center items-center">
        <div class="relative flex justify-between items-center desktop:w-3/4 h-full">
            ...
            <div class="flex flex-col gap-y-12">
                ...
                <div class="w-full h-auto flex flex-row justify-center items-center gap-x-4">
                    <ul class="flex flex-row justify-center items-center gap-x-4">
                        <li class="h-8 w-8 p-0.5 flex justify-center items-center">
                            <svg id="circle" y="0" x="0" width="100%" height="100%" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <circle id="outline" fill="none" stroke-width="1" stroke="#fff" stroke-linecap="round" cx="10" cy="10" r="9"/>
                                <circle id="inline" fill="none" stroke-width="1.5" stroke="#3AF" stroke-linecap="round" cx="10" cy="10" r="9"/>
                            </svg>
                        </li>
                        <li class="h-8 w-8 p-0.5 flex justify-center items-center">
                            <div class="h-1 w-1 rounded-full bg-white border-2 border-white"></div>
                        </li>
                        <li class="h-8 w-8 p-0.5 flex justify-center items-center">
                            <div class="h-1 w-1 rounded-full bg-white border-2 border-white"></div>
                        </li>
                    ...
                    <a href="#" class="text-lg">View all posts</a>
                </div>
            </div>
