        ...
        <div class="relative flex justify-between items-center laptop:w-3/4 desktop:w-1/2 h-full">
            ...
            <div class="flex flex-col gap-y-12 overflow-hidden w-full">
                <div class="w-full overflow-auto laptop:min-h-1/2 h-full">
                    @for($i = 0; $i < 4; $i++)
                        @if($i == 0)
                            <div class="flex flex-row absolute portfolio-slide active-portfolio-slide gap-x-24" data-slide-duration="2500">
                                <div class="slide-content relative flex-1 flex flex-col laptop:py-2 desktop:py-16">
                                    <div class="laptop:w-5/6 desktop:w-3/4 relative">
                                        ...
                                        <h3 class="relative font-bold text-2xl pb-6">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing
                                            elit.</h3>
                                        <p class="relative font-light text-base pb-10">Donec sollicitudin ullamcorper mi sit amet
                                            feugiat.
                                            ...
                                            non…</p>
                                        <a href="" class="relative inline-flex z-20 w-fit justify-center space-x-2 items-center primary-background primary-background-hover transition-all z-20 text-lg border border-primary-200 rounded-full px-4 py-2 backdrop-blur">
                                ...
                                <div class="relative flex-1 w-auto overflow-hidden rounded-lg h-auto">
                                    <div class="h-full w-auto overflow-hidden laptop:min-h-1/2 laptop:max-h-1/2">
                                        ...
                                        <img class="slide-img w-full object-center object-cover h-full" src="{{ asset('assets/files/images/landing/background.jpg') }}">
                                    </div>
                                </div>
                            </div>
                        @else
                            <div class="flex flex-row absolute portfolio-slide gap-x-24" data-slide-duration="2500">
                                <div class="slide-content relative flex-1 flex flex-col laptop:py-2 desktop:py-16">
                                    <div class="laptop:w-5/6 desktop:w-3/4 relative">
