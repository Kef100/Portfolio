<div class="w-full h-full bg-secondary-700 section fp-auto-height">
    <svg class="absolute -bottom-px" x="0" y="0" width="100%" height="100%" viewBox="0 0 100% 100%" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="after:content-[''] after:absolute after:left-24 after:bottom-10 after:bg-no-repeat after:bg-cross after:w-24 after:h-24"></div>
    ...
    <svg  class="absolute fill-secondary -bottom-px" x="0" y="0" width="100%" height="110" viewBox="0 0 100% 110" xmlns="http://www.w3.org/2000/svg">
