...
@section("content")
    <div class="flex flex-row">
        <aside class="flex flex-col w-auto h-screen">
            <a href="https://flowbite.com" class="flex items-center justify-center pl-2.5 py-4 bg-gray-700">
                <img src="{{ asset("assets/files/branding/favicon.svg") }}" class="h-6 mr-3 mobile-sm:h-14" alt="logo"/>
            </a>
            <div class="overflow-y-auto h-full py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
                <ul class="space-y-2">
                    ...
                    <li class="absolute bottom-2">
                        <a href="#" class="flex items-center justify-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white transition-all hover:bg-gray-100 dark:hover:bg-gray-700">
