...
@section('content')
    <div class="relative flex items-top justify-center min-h-screen">
        <div class="relative min-h-screen w-2/6 float-left">
            <div class="container flex items-center flex-col w-8/12 my-0 mx-auto h-full">
                <div class="tablet:w-3/4">
                    <img class="w-20" src="{{asset('assets/files/branding/logo-banner.svg')}}" alt="Qubiqx logo">
                </div>
                <h2 class="mt-8 font-bold text-xl">Portfolio</h2>
